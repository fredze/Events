...
import { EventOrderComponent } from 'app/entities/event-order/event-order.component';
...
describe('Component Tests', () => {
    describe('EventOrder Management Component', () => {
        let comp: EventOrderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(EventOrderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.eventOrders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
