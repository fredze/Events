...
public class EventOrderResourceIntTest {
    ...
    public void setup() {
        ...
        final EventOrderResource eventOrderResource = new EventOrderResource(eventRepository,mailService,userRepository,eventOrderRepository, eventOrderLineRepository);
