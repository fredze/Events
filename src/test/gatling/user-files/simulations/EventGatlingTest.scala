...
class EventGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Event entity")
        ...
        .repeat(2) {
            ...
            .post("/api/events")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "price":null, "responsable":"SAMPLE_TEXT", "totalPlaces":"0", "availablePlaces":"0", "dateEvent":"2020-01-01T00:00:00.000Z", "placeEvent":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "stateEvent":null, "pricipalPicture":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
