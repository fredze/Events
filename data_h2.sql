...
VALUES('Concert Future', 147.0, 'Me', 500, 128, to_date('2018-09-29', 'yyyy-mm-dd'), 'Lyon', 'Wait for the one and only Future, in Lyon for an unforgettable night.', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Music' LIMIT 1));
...
INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Concert Migos', 180.0, 'Me', 3000, 302, to_date('2018-11-30', 'yyyy-mm-dd'), 'Paris', 'Offset, Quavo and Takeoff! Listen to the brand new album of Migos LIVE in Parc Des Princes. Be there at 8 P.M.', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Music' LIMIT 1));
...
INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Italian Opera', 12.0, 'Me', 400, 0, to_date('2019-06-30', 'yyyy-mm-dd'), 'Madrid', 'For the first time, exclusively on EVE, you can attend the famous italian opera with the majestic and unique artists.', 'UNAVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Theatre' LIMIT 1));

INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Swan Lake', 48.0, 'Me', 250, 8, to_date('2018-10-01', 'yyyy-mm-dd'), 'القاهرة', 'Get ready for the amazing opera experience in the great Egypt. Don''t miss the fantastic Swan Lake.', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Theatre' LIMIT 1));
...
INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Arsenal - Chelsea', 458.0, 'Me', 2500, 1000, to_date('2019-04-29', 'yyyy-mm-dd'), 'London, Emirates Stadium', 'Hurry up and buy your places for the CHAMPIONS LEAGUE SEMI-FINAL!', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Sports' LIMIT 1));

INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Lakers - Celtics', 1200.0, 'Me', 900, 338, to_date('2019-01-14', 'yyyy-mm-dd'), 'Los Angeles', 'Don''t miss out THE Derby', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Sports' LIMIT 1));

INSERT INTO
EVENT(NAME, PRICE, RESPONSABLE, TOTAL_PLACES, AVAILABLE_PLACES, DATE_EVENT, PLACE_EVENT, DESCRIPTION, STATE_EVENT, CATEGORY_ID)
VALUES('Nadal - Federer', 299.0, 'Me', 700, 238, to_date('2019-01-05', 'yyyy-mm-dd'), 'Lisbon', 'Wimbeldon''s final', 'AVAILABLE', (SELECT ID FROM CATEGORY WHERE NAME='Sports' LIMIT 1));
